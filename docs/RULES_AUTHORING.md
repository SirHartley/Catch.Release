...
Java can match rows and read their text without an open dialog, for example to fill intel entries from rules rows. Verified in the 0.98a-RC8 source; bundle line numbers refer to `starsector-knowledge`:
