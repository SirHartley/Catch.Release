...
That industry has no adequate supply chain. There are no freight routes, fishing fleets, shipyards or port quotas that account for the catch on sale.

There is one Fisherman, present in inhabited systems at once, whose boats could not supply the Sector. Nobody has checked the arithmetic.
...
Independent fishers own or work a rupture.

- Pirate pressure is commercial extortion: protection payments, idle boats, repair costs and shrinking margins. A fisher can be angry and practical rather than merely afraid.
...
LINE refers to the drone retrieval arrangement. Its visible line helps the player follow the action; it is not a mechanical fishing line.

Trade dialogue can say “line” or “rope,” but technical narration must not describe steel cable, reels, winches or tied knots.

### Harpoon

The Harpoon delivers and retrieves ROD equipment as an aimed, high-speed projectile. It is the aggressive alternative to sending drones through a natural rupture.

Its visible retrieval trace is not a steel cable.
...
Church and Path objections are religious; other patrols can regulate dangerous operation, interference, unregistered hardware, high-energy devices and hull damage without understanding the fabric.
...
Hyperspace contains wreckage and lost cargo, so retrieving ordinary debris requires little explanation.

Improbable treasure is a gameplay concession. Do not invent a theory for every recovered blueprint.

### Range data

Range data correctly describes where a pattern occurs and which conditions are relevant. The trade buys and sells it, the Fisherman supplies it, and the map uses it.

How the trade can possess such accurate information remains unexplained.

Nobody in the trade has scrutinized how those charts can be correct.
...
He is not coy, protecting the player's fragile mind, preserving a supernatural secret or posing as a mysterious mentor.

He gives the useful part of an answer and stops before precision makes trouble. He knows when he has left a question unanswered.
...
The crew are heavily altered but remain within reality's self-correction.

They may exchange faces or places, pass through solid objects, change between camera cuts or have inconsistent names. They regard their work as ordinary.

They do not object to or discuss these changes. The Fisherman sees them and usually does not care.

Keep these actions incidental; do not stop to describe their horror.
...
Show what the coat does.

- An item can exceed its pocket's size.
- He can reach past an internal shelf.
- A hand can already occupy the pocket he reaches into.
- Stock may be recorded before a sale.
- Crabs may appear unpacked.
- Something inside may knock back.
...
People retrieve patterns because they can, and many are edible.

Patterns began appearing beneath ruptures; somebody found a way to retrieve them. The commercial origin does not need a more elaborate explanation.

Catch also supplies research, collections, entertainment, gambling and prestige purchases. Buyers need not understand its ultimate origin.
...
Recovered Fisherman property is heavy, crane-handled LYNE hardware or a transponder/service assembly, not usable early Harpoon equipment.
...
Explain LYNE drones, basic ROD retrieval, fish/pattern terminology and “ghost” as old spacer slang. Do not explain why patterns become fish.

### Second assignment

Send the player to a near-Core system with lower coherence. The Fisherman is there too; the player may question this without receiving a resolution.

### Second return

Introduce the Outfitter, grant Breach Lights and Harpoon, and explain practical operation. Hide categories for unowned hardware.

### Third catch

Teach the open-space Breach Light + Harpoon loop. A special/golden tutorial target is appropriate.

### Third return

Unlock the remaining owned-equipment shop categories. Give two Common range entries and explain range data and the planner: there are now two destinations to plan for.

### Final assignment and return

Retrieve both charted patterns, then unlock range-data purchases and grant two Common, one Uncommon and one Rare range entry.
...
The two tournament children have complementary roles.

- The louder child negotiates and argues the case.
- The quieter child keeps the bracket and remembers the wording.

When they appoint an outside captain to allocate two selected fish, that decision becomes binding playground diplomacy.
...
The TriTuber is the setting's equivalent of an insufferable short-form video producer.

His working attention span is six seconds long. He speaks in hooks, reveals, retention cliffs, thumbnails, sponsor pools, comments, replays and follows.

Even a private exchange becomes a performance for the feed; the person in front of him is a guest, prop and reaction shot before they are a person.

He acts familiar immediately, as if the other person were already part of his show.

He addresses an imagined audience in the middle of conversations, stages reactions before anything has happened, turns refusal into content and treats confusion as a resource.

He wants the first frame to make a promise, the next to contradict it and the comments to fight over the gap. He is exhausting because the production never switches off.
...
He understands visible specimens, practical coherence readings and what performs on camera. He does not understand the fabric, the Fisherman's nature or why low-coherence fish behave as they do.

To him, reality breaking is valuable because people replay it.
...
May frame the technology as trespass, arrogance or sinful interference. That is doctrine, not proof that they know the actual mechanism.

### The Path

May hate the equipment more violently. Their anger does not give them technical knowledge of the fabric.
...
Do not write every Church character as a fanatic. Faith can be completely sincere and completely ordinary.
...
The Fisherman may know some or all of these. That does not make them available to the prose.
...
These are calibration references only. Never mention them in fiction.
...
These are tonal references, not lore sources. Catch.Release still has to sound like **Starsector**.
...
If a broad-setting detail is not required, do not invent it merely to decorate the sentence. A generic "yard", "patrol", "station" or "trade office" is often better than an unnecessary named institution.
