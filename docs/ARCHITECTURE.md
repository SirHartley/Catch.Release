...
old-save flag without a separate repeat-question state. Answered producers use the canonical
Common-rarity colour so they recede without disappearing. The menu pages topics six at a time,
