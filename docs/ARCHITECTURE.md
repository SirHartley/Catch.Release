...
least three epic-tier treasures. Four of them fight back in kind - the Longliner's poppable hull
shield, the Quorum's splinter escort, the Lantern Jack's charge-and-swallow shield, the moray's
flung motes - through `LegendaryShields` and the harpoon's deflection hook. The two calm-fabric commons (`nav_bobber`, `plume_remora`) carry `maxAberration
