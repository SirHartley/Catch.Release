...
| `searchlight/ability/SearchlightAbilityPlugin.java` | The breach lamps: spools them up, exposes `isLit(mote)`, beam slow, detectability penalty, yields to open ponds |
