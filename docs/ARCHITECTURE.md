...
minigame's coin-filled chest opening, treasure spawn/pickup cues, the bar-boundary cue and two
outcome hooks), the skillshot framework's denied blip, and two vanilla character-screen ids re-declared at reduced
volume. The minigame
