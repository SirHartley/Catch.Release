...
| `FishRewardRoller.java` | Rolls a commodity-free payment scaled to a job's worth and preserves that value on survey rewards for live redundancy conversion |
