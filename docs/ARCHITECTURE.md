...
| File | What it does |
|---|---|
| `FishConstants.java` | Every magic number for minigame, result cards, celebration, treasure and codex, including the IDE-editable input sound ids and click-edge toggle |
