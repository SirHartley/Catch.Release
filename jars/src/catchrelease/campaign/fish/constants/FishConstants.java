...
public class FishConstants {
    ...
    public static final float MINIGAME_SINKER_CEILING = 0.55f;
    public static final float MINIGAME_FLOATER_FLOOR = 0.45f;
    ...
    public static final float MINIGAME_SURGE_MIN = 0.6f;
    public static final float MINIGAME_SURGE_MAX = 0.95f;
    public static final float MINIGAME_SURGE_THINK = 0.6f;
    public static final float MINIGAME_QUICK_THINK = 0.3f;
    public static final float MINIGAME_WEAVER_SHORT_MIN = 0.35f;
    public static final float MINIGAME_WEAVER_SHORT_MAX = 0.65f;
    public static final float MINIGAME_TWITCHER_BOUND_MIN = 0.35f;
    public static final float MINIGAME_TWITCHER_BOUND_MAX = 0.55f;
    ...
    public static final float MINIGAME_TELL_LEAN = 4f;
    public static final float MINIGAME_TELL_PULSE = 2f;
    ...
    public static final float MINIGAME_TELL_CUE_GAP = 24f;
    public static final float MINIGAME_TELL_CUE_TRAVEL = 6f;
    public static final float MINIGAME_TELL_CUE_WIDTH = 12f;
    public static final float MINIGAME_TELL_CUE_HEIGHT = 5f;
    public static final float MINIGAME_TELL_CUE_LINE = 2f;
    public static final float MINIGAME_TELL_CUE_ALPHA = 0.8f;
