...
public class FishConstants {
    ...
    public static final float MINIGAME_WEAVER_LOW = 0.15f;
    public static final float MINIGAME_WEAVER_HIGH = 0.85f;
    public static final float MINIGAME_WEAVER_ARRIVE = 0.06f;
    public static final float MINIGAME_WEAVER_DWELL_FLOOR = 0.6f;
    public static final float MINIGAME_TWITCHER_CADENCE = 0.35f;
    public static final float MINIGAME_TWITCHER_HOP = 0.16f;
    public static final float MINIGAME_TWITCHER_LEAP = 0.45f;
    public static final float MINIGAME_TWITCHER_LEAP_CHANCE = 0.15f;
    public static final float MINIGAME_LUNGER_PATIENCE = 2.5f;
    public static final float MINIGAME_LUNGER_NEAR = 0.08f;
    public static final float MINIGAME_LUNGER_DASH_MULT = 2.1f;
    public static final float MINIGAME_LUNGER_CREEP_MULT = 0.15f;
